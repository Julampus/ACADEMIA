...
Capital accrues capital by converting living labour (via. accumulated labour) into commodities
It is the materials, machines, and land which make up the process of production (A machine under a certain social situation). Necessitates the exploitation of the laborer. Under [[Capitalism]], it continues to consolidate into the hands of a wealthy few and will eventually unmake its own system.

On the exploitation of the worker
