...
Serano describes Butler's theory of performativity as external observers citing gender (whenever gendered language or expectations are used; e.g. "she," "girl," "motherhood") and thus establishing it to be so
	Our expectations of gender both influence our own gendered expressions (and make them so) as well as other people's gender expressions (and make them so)
